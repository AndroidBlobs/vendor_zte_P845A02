...
include $(CLEAR_VARS)
LOCAL_MODULE := ZTE_Bridge
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/vendor/app/ZTE_Bridge/ZTE_Bridge.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := vendor.qti.zyitong.device-V1.0-java
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/vendor/framework/vendor.qti.zyitong.device-V1.0-java.jar
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := .jar
...
include $(CLEAR_VARS)
LOCAL_MODULE := switch_sensor0
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/vendor/etc/camera/beautiful_app/switch_sensor0.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := switch_sensor1
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/vendor/etc/camera/beautiful_app/switch_sensor1.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_SUFFIX := .xml
LOCAL_VENDOR_MODULE := true
